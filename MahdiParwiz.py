...
def main():
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/AFG_Hack_Team")
        main()
    elif mirwais in ["3","03"]:
        os.system("xdg-open https://t.me/DarkNightHacker001")
        main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[Mahdi+Parwiz] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
